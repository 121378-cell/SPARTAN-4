...
import { 
  ...
  Thermometer, Wind, Gauge, Zap, Target, Sparkles, Orbit
} from "lucide-react";

interface HolographicGymProps {
  onBack: () => void;
}
...
const HolographicGym = memo(function HolographicGym({ onBack }: HolographicGymProps) {
    ...
    <div className="spartan-xxii-body min-h-screen p-6">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex justify-between items-center mb-8">
          <div>
            <h1 className="holographic-text text-4xl mb-2" data-text="Gimnasio Holográfico">
              Gimnasio Holográfico
            </h1>
            <p className="text-lg text-gray-300">
              Entornos de entrenamiento inmersivos con gravedad artificial y condiciones extremas
            </p>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <Card className="quantum-card">
              <CardHeader>
                <CardTitle className="holographic-text text-2xl" data-text="Entornos Disponibles">
                  Entornos Disponibles
                </CardTitle>
                <CardDescription className="text-gray-300">
                  Selecciona un entorno holográfico para tu sesión de entrenamiento extremo
                </CardDescription>
              </CardHeader>
              <CardContent>
