...
exports.spatialAudioService = exports.SpatialAudioService = void 0;
class SpatialAudioService {
     ...
     */
    updateCuePosition(cueId, position) {
        const cue = this.activeCues.get(cueId);
        if (!cue || !this.config.spatialEnabled)
            return;
     ...
     */
    playFormCorrectionCue(message, position) {
        const cue = {
            id: `form-${Date.now()}`,
            message,
            position,
...
exports.SpatialAudioService = SpatialAudioService;
// Export singleton instance
exports.spatialAudioService = SpatialAudioService.getInstance();
// Example usage:
